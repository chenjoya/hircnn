...
from dohstate import get_dohstate
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="100doh/", type=str, help="dataset path")
    parser.add_argument("--dataset", default="dohstate", type=str, help="dataset name")
...
def main(args):
    ...
    dataset_test, _ = get_dataset(args.dataset, "test", get_transform(False, args), args.data_path)
    ...
    model = getattr(torchvision.models.detection, args.model)(
        weights=args.weights, weights_backbone=args.weights_backbone, **kwargs
    )
    if num_classes != model.roi_heads.box_predictor.cls_score.out_features:
